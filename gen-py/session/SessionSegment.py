...
class Client(Iface):
  ...
  def calculate(self, request):
    ...
    Parameters:
     - request
    """
    self.send_calculate(request)
    return self.recv_calculate()

  def send_calculate(self, request):
...
class Processor(Iface, TProcessor):
  ...
  def process_calculate(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = calculate_result()
    result.success = self._handler.calculate(args.request)
...
class calculate_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (SessSegRequest, SessSegRequest.thrift_spec), None, ), # 1
  )
...
class calculate_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (SessSegResponse, SessSegResponse.thrift_spec), None, ), # 0
  )
